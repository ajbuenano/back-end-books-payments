package com.actividad2.ms_books_payments.controller;
...
import com.actividad2.ms_books_payments.service.OrdersService;
...
public class OrdersController {
    ...
    public ResponseEntity<String> get() {
        return ResponseEntity.ok("Hello from Railway + Orders!");
    }
